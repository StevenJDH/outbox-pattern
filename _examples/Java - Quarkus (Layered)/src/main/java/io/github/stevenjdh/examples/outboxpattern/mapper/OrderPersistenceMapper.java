...
public interface OrderPersistenceMapper {
    ...
    OrderEntity toEntity(Order order, @Context OrderItemPersistenceMapper itemMapper);

    @AfterMapping
    default void afterToEntity(@MappingTarget OrderEntity entity, Order order,
    ...
    @AfterMapping
    default void afterToOrder(@MappingTarget Order order, OrderEntity entity) {
