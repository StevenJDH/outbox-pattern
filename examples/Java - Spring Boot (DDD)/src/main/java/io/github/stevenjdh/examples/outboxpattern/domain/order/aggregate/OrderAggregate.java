...
package io.github.stevenjdh.examples.outboxpattern.domain.order.aggregate;
...
import io.github.stevenjdh.examples.outboxpattern.domain.shared.base.BaseAggregateRoot;
import java.time.Instant;
import java.util.Collections;
import java.util.List;
import java.util.UUID;

public class OrderAggregate extends BaseAggregateRoot<UUID> {
    ...
    public OrderAggregate(UUID id, Instant orderDate, Customer customer, List<OrderItem> items) {
